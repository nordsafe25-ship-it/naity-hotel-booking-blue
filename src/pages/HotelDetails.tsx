      ...
      <div className="relative h-64 md:h-96 overflow-hidden">
        ...
        <div className="absolute bottom-6 left-0 right-0 container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-accent-foreground">{hotel.name}</h1>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {rooms.map((room, i) => (
              ...
              >
                <img src={room.image} alt={room.type} className="w-full h-40 object-cover" />
